# In December 2022 and May 2023 Effie completed two experiments with DC3000 and p25.c2 Rb-Tnseq grown in two ecotypes. This file is building a list for each experiment which is then written to an rds. Modified this script in 4/2025 to have the correct ortholog file. In August 2025 Effie found an issue with the counts table for p25.c2 and amended here.

#this file was last updated on 10/7/2025
...
setwd('/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_10_2025/')
#setwd("/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/counts_p25c2_new_analysis_aug_25/")

#setwd("~/Google\ Drive/My\ Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/in_planta_rbtnseq_p25c2_dc3000")
#Until April 2025 these scripts had been using bad ortholog files. EFfie told me she redid them
...
dc_22_path <- ("~/Google\ Drive/My\ Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/in_planta_rbtnseq_p25c2_dc3000/in_planta_dec22/dc3000_dec22/")
#p25_22 <- ("/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/counts_p25c2_new_analysis_aug_25/")
p25_22 <- ("/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/counts_p25c2_final_October_2025/p25_22/")
dc_23 <- ("~/Google\ Drive/My\ Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/in_planta_rbtnseq_p25c2_dc3000/in_planta_may23/dc3000_may23/")
#p25_23 <- ("/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/comparing_count_tables/p25c2_count_tables_for_comparison/")
p25_23 <- ("/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/counts_p25c2_final_October_2025/p25_23")
...
saveRDS(dc_22_counts, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/dc22.rds")

#p25c2 2022
path_files <- p25_22
#gff <- "in_planta_dec22_p25c2_counts_aug25_header.gff"
gff <- "in_planta_dec22_p25c2_counts_sep25_header.gff"
sample_info <-"sample_info_p25c2_0323.txt"
p25_22_counts <- compile_experiment(path_files, gff, sample_info)
saveRDS(p25_22_counts, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/p25c2_22_redone_10_2025.rds" )
...
saveRDS(dc_23_counts, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/dc23.rds")

#p25c2 2023
path_files <- p25_23
#gff <- "/in_planta_may23_new_aug25_test_header.gff"
gff<- "/p25c2_sep25_old_ref_counts_header.gff"
sample_info <-"/in_planta_may23_info_p25c2.txt"
p25_23_counts <- compile_experiment(path_files, gff, sample_info)
saveRDS(p25_23_counts, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/p25c2_23_redone_10_2025.rds")
...
pull_gene_name_ortho <- function(counts_table, orthologs, start_gene){
  ...
  for(i in 1:length(poo4)){
    ...
    if (is.na(new_poo4[i]) || new_poo4[i] == "") { 
      new_poo4[i] = poo4[i]
      #print(i)
      print(poo4[i])}
    if(is.na(new_poo4[i])) {print(i)
    }
  }
...
dc22_relabel1 <- pull_gene_name(dc_22_counts, start_gene = 10)
dc23_relabel1 <- pull_gene_name(dc_23_counts, start_gene = 9)
...
dc22_relabel <- remove_gene(dc22_relabel1, start_gene = 11)
dc23_relabel <- remove_gene(dc23_relabel1, start_gene = 9)

#now I need to remove some columns. Which columns am I removing? I am removing the ones that dont match properly. What a headache
...
dc23_relabel$plant <- ifelse(dc23_relabel$plant == "ey15_2", "Ey15_2",
                                    ifelse(dc23_relabel$plant == "col_0", "Col_0", p25_23_new2$plant))
p25_23_new2$plant <- ifelse(p25_23_new2$plant == "ey15_2", "Ey15_2",
                             ifelse(p25_23_new2$plant == "col_0", "Col_0", p25_23_new2$plant))
...
#Previously 78 of the p25 columns are not unique (it seems like two of the p25 genes map to the same DC3000 ortholog. What can we do? how about merge colulmns with the same column name)
p25_exp <- full_join(x=p25_22_new2, y=p25_23_new2)

# all experiment join

all_exp <- full_join(x=dc_exp, y=p25_exp)
#  saveRDS(all_exp, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/all_p25_dc_axenic_8_2025.rds")
#write.csv(all_exp, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/all_p25_dc_axenic_924_2025.csv", quote = FALSE, row.names =FALSE)
write.csv(all_exp, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_8_2025/full_experiments/all_p25_dc_axenic_10_07_2025.csv", quote = FALSE, row.names =FALSE)

# is this still true#only has numbers through row 285 for number of reads. Weirdly
