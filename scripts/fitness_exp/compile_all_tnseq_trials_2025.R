...
all_exp <- full_join(x=dc_exp, y=p25_exp)
  saveRDS(all_exp, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/in_planta_rbtnseq_p25c2_dc3000/all_p25_dc_axenic_5_2025.rds")
write.csv(all_exp, "/Users/talia/Library/CloudStorage/GoogleDrive-tkarasov@gmail.com/My Drive/Utah_Professorship/projects/Tnseq/compiled_trials_3_2024/data/in_planta_rbtnseq_p25c2_dc3000/all_p25_dc_axenic_5_2025.csv", quote = FALSE, row.names =FALSE)
